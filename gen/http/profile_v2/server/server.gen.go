...
type ServerInterface interface {
	...
	// (DELETE /profile/{id})
	DeleteProfileByID(w http.ResponseWriter, r *http.Request, id string)
	// Get a profile by ID
	// (GET /profile/{id})
...
// Delete a profile by ID
// (DELETE /profile/{id})
func (_ Unimplemented) DeleteProfileByID(w http.ResponseWriter, r *http.Request, id string) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
// DeleteProfileByID operation middleware
func (sh *strictHandler) DeleteProfileByID(w http.ResponseWriter, r *http.Request, id string) {
...
// GetProfileByID operation middleware
func (sh *strictHandler) GetProfileByID(w http.ResponseWriter, r *http.Request, id string) {
